...
static bool findBiarchMultilibs(const Driver &D,
  ...
  Multilib Alt64 = MultilibBuilder()
                       ...
                       .flag("-mabi=purecap", /*Disallow=*/true)
                       .makeMultilib();
  ...
  Multilib Altx32 = MultilibBuilder()
                        ...
                        .flag("-mabi=purecap", /*Disallow=*/true)
                        .makeMultilib();
  Multilib Alt64c = MultilibBuilder()
  ...
  Multilib::flags_list Flags;
  addMultilibFlag(TargetTriple.isArch64Bit() && !IsX32  && !IsPurecap, "-m64", Flags);
  addMultilibFlag(TargetTriple.isArch32Bit() && !IsPurecap, "-m32", Flags);
  addMultilibFlag(TargetTriple.isArch64Bit() && IsX32  && !IsPurecap, "-mx32", Flags);
  ...
  if (Result.SelectedMultilibs.back() == Alt64 ||
      ...
      Result.SelectedMultilibs.back() == Alt64c)
