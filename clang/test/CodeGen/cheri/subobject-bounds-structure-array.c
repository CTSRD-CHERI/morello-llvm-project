...
// CHECK-NEXT:    tail call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* noundef nonnull align 8 dereferenceable(56) [[TMP0]], i8 addrspace(200)* noundef nonnull align 8 dereferenceable(56) [[TMP1]], i64 56, i1 false) #[[ATTR11:[0-9]+]], !tbaa.struct !6
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    tail call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* noundef nonnull align 16 dereferenceable(48) [[TMP0]], i8 addrspace(200)* noundef nonnull align 16 dereferenceable(48) [[TMP1]], i64 48, i1 false) #[[ATTR12:[0-9]+]], !tbaa.struct !13
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* noundef [[TMP2]]) #[[ATTR13:[0-9]+]]
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #[[ATTR13]]
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* noundef [[TMP0]]) #[[ATTR13]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #[[ATTR13]]
// CHECK-NEXT:    ret i32 0
//
...
// UTC_ARGS: --disable
// CHECK: attributes #[[ATTR11]] = { no_preserve_cheri_tags }
// CHECK: attributes #[[ATTR12]] = { must_preserve_cheri_tags }
