...
// RXUN: %cheri_purecap_cc1 -S -O2 %s -o - -verify | FileCheck %s --check-prefix ASM
...
// CHECK-NEXT:    call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* noundef nonnull align 8 dereferenceable(4096) [[TMP0]], i8 addrspace(200)* noundef nonnull align 4 dereferenceable(4096) bitcast ([[STRUCT_DWARF_ERROR]] addrspace(200)* @a to i8 addrspace(200)*), i64 4096, i1 false) #[[ATTR5:[0-9]+]], !tbaa.struct !2
...
// UTC_ARGS: --disable
// CHECK: attributes #[[ATTR5]] = { no_preserve_cheri_tags }
