...
// RUN: %cheri_purecap_cc1 %s -O0 -emit-llvm -o - | FileCheck %s
// RUN: %cheri_purecap_cc1 %s -O2 -S -o - | FileCheck %s -check-prefixes ASM
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds [[UNION_CALLDATA]], ptr addrspace(200) [[FOO]], i32 0, i32 0
// CHECK-NEXT:    [[COERCE_DIVE1:%.*]] = getelementptr inbounds [[STRUCT_ANON:%.*]], ptr addrspace(200) [[COERCE_DIVE]], i32 0, i32 0
// CHECK-NEXT:    store ptr addrspace(200) [[FOO_COERCE:%.*]], ptr addrspace(200) [[COERCE_DIVE1]], align 16
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @test_onelevel_helper(ptr addrspace(200) inreg [[TMP0]])
// CHECK-NEXT:    ret void
//
void test_onelevel() {
  union CallData foo;
...
// CHECK-NEXT:    [[COERCE_DIVE:%.*]] = getelementptr inbounds [[UNION_DEEPNODIVE]], ptr addrspace(200) [[D]], i32 0, i32 0
// CHECK-NEXT:    [[COERCE_DIVE1:%.*]] = getelementptr inbounds [[STRUCT_ANON_2:%.*]], ptr addrspace(200) [[COERCE_DIVE]], i32 0, i32 0
// CHECK-NEXT:    [[COERCE_DIVE2:%.*]] = getelementptr inbounds [[STRUCT_ANON_3:%.*]], ptr addrspace(200) [[COERCE_DIVE1]], i32 0, i32 0
// CHECK-NEXT:    store ptr addrspace(200) [[D_COERCE:%.*]], ptr addrspace(200) [[COERCE_DIVE2]], align 16
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[COERCE_DIVE2:%.*]] = getelementptr inbounds [[STRUCT_ANON_3]], ptr addrspace(200) [[COERCE_DIVE1]], i32 0, i32 0
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr addrspace(200), ptr addrspace(200) [[COERCE_DIVE2]], align 16
// CHECK-NEXT:    call void @test_twolevels_nodive_helper(ptr addrspace(200) inreg [[TMP0]])
// CHECK-NEXT:    ret void
//
