...
// MORELLO-NEXT:  entry:
// MORELLO-NEXT:    [[TMP0:%.*]] = load ptr addrspace(200), ptr addrspace(200) [[EXPECTED]], align 16
// MORELLO-NEXT:    [[TMP1:%.*]] = load ptr addrspace(200), ptr addrspace(200) [[DESIRED]], align 16
// MORELLO-NEXT:    [[TMP2:%.*]] = cmpxchg weak ptr addrspace(200) [[PTR]], ptr addrspace(200) [[TMP0]], ptr addrspace(200) [[TMP1]] monotonic monotonic, align 16
// MORELLO-NEXT:    [[TMP3:%.*]] = extractvalue { ptr addrspace(200), i1 } [[TMP2]], 0
// MORELLO-NEXT:    [[TMP4:%.*]] = extractvalue { ptr addrspace(200), i1 } [[TMP2]], 1
// MORELLO-NEXT:    br i1 [[TMP4]], label [[CMPXCHG_CONTINUE:%.*]], label [[CMPXCHG_STORE_EXPECTED:%.*]]
// MORELLO:       cmpxchg.store_expected:
// MORELLO-NEXT:    store ptr addrspace(200) [[TMP3]], ptr addrspace(200) [[EXPECTED]], align 16
// MORELLO-NEXT:    br label [[CMPXCHG_CONTINUE]]
// MORELLO:       cmpxchg.continue:
// MORELLO-NEXT:    [[FROMBOOL:%.*]] = zext i1 [[TMP4]] to i8
// MORELLO-NEXT:    [[TOBOOL:%.*]] = trunc i8 [[FROMBOOL]] to i1
// MORELLO-NEXT:    ret void
//
...
// MORELLO-NEXT:  entry:
// MORELLO-NEXT:    call void @__atomic_load(i64 noundef 32, ptr addrspace(200) noundef [[PTR]], ptr addrspace(200) noundef [[RET]], i32 noundef 0)
// MORELLO-NEXT:    ret void
//
...
// MORELLO-SAME: (ptr addrspace(200) noundef [[PTR:%.*]], ptr addrspace(200) noundef [[VAL:%.*]]) addrspace(200) #[[ATTR0]] {
// MORELLO-NEXT:  entry:
// MORELLO-NEXT:    call void @__atomic_store(i64 noundef 32, ptr addrspace(200) noundef [[PTR]], ptr addrspace(200) noundef [[VAL]], i32 noundef 0)
// MORELLO-NEXT:    ret void
//
...
// MORELLO-SAME: (ptr addrspace(200) noundef [[PTR:%.*]], ptr addrspace(200) noundef [[VAL:%.*]], ptr addrspace(200) noundef [[RET:%.*]]) addrspace(200) #[[ATTR0]] {
// MORELLO-NEXT:  entry:
// MORELLO-NEXT:    call void @__atomic_exchange(i64 noundef 32, ptr addrspace(200) noundef [[PTR]], ptr addrspace(200) noundef [[VAL]], ptr addrspace(200) noundef [[RET]], i32 noundef 0)
// MORELLO-NEXT:    ret void
//
...
// MORELLO-SAME: (ptr addrspace(200) noundef [[PTR:%.*]], ptr addrspace(200) noundef [[EXPECTED:%.*]], ptr addrspace(200) noundef [[DESIRED:%.*]]) addrspace(200) #[[ATTR0]] {
// MORELLO-NEXT:  entry:
// MORELLO-NEXT:    [[CALL:%.*]] = call i1 @__atomic_compare_exchange(i64 noundef 32, ptr addrspace(200) noundef [[PTR]], ptr addrspace(200) noundef [[EXPECTED]], ptr addrspace(200) noundef [[DESIRED]], i32 noundef 0, i32 noundef 0)
// MORELLO-NEXT:    ret void
//
