...
void test_dst_unliagned_src_cap_memcpy(void *align1, align2_ptr align2, align4_ptr align4, align8_ptr align8, align_cap_ptr align_cap, a *src) {
  ...
  // CHECK-SAME: i8 addrspace(200)* noundef %align1,
  // CHECK-SAME: i8 addrspace(200)* noundef align 2 %align2,
  // CHECK-SAME: i8 addrspace(200)* noundef align 4 %align4,
  // CHECK-SAME: i8 addrspace(200)* noundef align 8 %align8,
  // CHECK-SAME: i8 addrspace(200)* noundef align 16 %align_cap,
  // CHECK-SAME: i8 addrspace(200)* addrspace(200)* noundef %src)
