...
// RUN: %clang_cc1 -ffreestanding -triple aarch64-none-eabi -target-feature +morello -target-feature +c64 -target-abi purecap -O0 -disable-O0-optnone -S -emit-llvm -o - %s | opt -S -passes=mem2reg | FileCheck %s
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.aarch64.prefetch.p200(ptr addrspace(200) null, i32 0, i32 0, i32 0, i32 1)
// CHECK-NEXT:    ret void
//
void test_pld() {
  __pld(0);
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.aarch64.prefetch.p200(ptr addrspace(200) null, i32 1, i32 2, i32 0, i32 1)
// CHECK-NEXT:    ret void
//
void test_pldx() {
  __pldx(1, 2, 0, 0);
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.aarch64.prefetch.p200(ptr addrspace(200) null, i32 0, i32 0, i32 0, i32 0)
// CHECK-NEXT:    ret void
//
void test_pli() {
  __pli(0);
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @llvm.aarch64.prefetch.p200(ptr addrspace(200) null, i32 0, i32 2, i32 0, i32 0)
// CHECK-NEXT:    ret void
//
void test_plix() {
  __plix(2, 0, 0);
...
// CHECK-NEXT:    br i1 [[CMP_I_I11_I]], label [[IF_THEN_I_I17_I:%.*]], label [[IF_END_I_I12_I:%.*]]
// CHECK:       if.then.i.i17.i:
// CHECK-NEXT:    br label [[__REV16_EXIT18_I:%.*]]
// CHECK:       if.end.i.i12.i:
...
// CHECK-NEXT:    [[RETVAL_I_I6_I_0:%.*]] = phi i32 [ [[TMP0]], [[IF_THEN_I_I17_I]] ], [ [[OR_I_I16_I]], [[IF_END_I_I12_I]] ]
