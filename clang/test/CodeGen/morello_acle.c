...
// RUN: %clang_cc1 -ffreestanding -triple aarch64-none-eabi -target-feature +morello -target-feature +c64 -target-abi purecap -target-feature +neon -target-feature +crc -target-feature +crypto -O0 -disable-O0-optnone -S -emit-llvm -o - %s | opt -S -passes=mem2reg | FileCheck %s
