...
uint64_t InputSectionBase::getRelocTargetVA(RelType type, int64_t a, uint64_t p,
  ...
  case R_MORELLO_CAPFRAG_ADDEND:
    return sym.getVA(a) - getMorelloBaseAddress(a, sym, this, offset);
  ...
  case R_MORELLO_CAPFRAG_BASE:
    return getMorelloBaseAddress(a, sym, this, offset);
  case R_MORELLO_CAPFRAG_SIZE_AND_PERM:
    return getMorelloSizeAndPermissions(a, sym, this, offset);
