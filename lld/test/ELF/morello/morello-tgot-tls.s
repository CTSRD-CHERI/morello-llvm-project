...
// SO-REL:      .rela.dyn {
// SO-REL-NEXT:   0x20560 R_MORELLO_TLS_TGOTREL64 - 0x0
// SO-REL-NEXT:   0x20570 R_MORELLO_TGOT_TLSDESC - 0x0
// SO-REL-NEXT:   0x20590 R_MORELLO_TLS_TGOTREL64 - 0x10
// SO-REL-NEXT:   0x205A0 R_MORELLO_TGOT_TLSDESC - 0x10
// SO-REL-NEXT: }
// SO-REL:      .rela.tgot {
...
// SO-GOT: section '.got':
// SO-GOT-NEXT: 0x00020560 00000000 00000000 00000000 00000000
// SO-GOT-NEXT: 0x00020570 00000000 00000000 00000000 00000000
// SO-GOT-NEXT: 0x00020580 00000000 00000000 00000000 00000000
...
/// GTLSDESC(evar) = 0x20570
// SO-DIS:      10440: adrp c0, 0x20000
// SO-DIS-NEXT:        ldr c2, [c0, #0x570]
// SO-DIS-NEXT:        add c0, c0, #0x570
// SO-DIS-NEXT:        blr c2

/// GTGOTREL(evar) = 0x20560
// SO-DIS:      10450: adrp c0, 0x20000
// SO-DIS-NEXT:        ldr x0, [c0, #0x560]

/// GTLSDESC(lvar) = 0x205a0
// SO-DIS:      10458: adrp c0, 0x20000
// SO-DIS-NEXT:        ldr c2, [c0, #0x5a0]
// SO-DIS-NEXT:        add c0, c0, #0x5a0
// SO-DIS-NEXT:        blr c2
