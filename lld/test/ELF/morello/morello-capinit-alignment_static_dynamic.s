...
// RUN: ld.lld --morello-c64-plt --morello-static-caps=elf %t.o -o %t
...
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x200290
// CHECK-NEXT:   }
// CHECK-NEXT:   Relocation {
// CHECK-NEXT:     Offset: 0x230010
// CHECK-NEXT:     Type: R_MORELLO_RELATIVE
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x200291
// CHECK-NEXT:   }
// CHECK-NEXT:   Relocation {
// CHECK-NEXT:     Offset: 0x230020
// CHECK-NEXT:     Type: R_MORELLO_RELATIVE
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x201294
// CHECK-NEXT:   }
// CHECK-NEXT:   Relocation {
// CHECK-NEXT:     Offset: 0x230030
// CHECK-NEXT:     Type: R_MORELLO_RELATIVE
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x220000
// CHECK-NEXT:   }
// CHECK-NEXT:   Relocation {
// CHECK-NEXT:     Offset: 0x230040
// CHECK-NEXT:     Type: R_MORELLO_RELATIVE
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x220008
// CHECK-NEXT:   }
// CHECK-NEXT:   Relocation {
// CHECK-NEXT:     Offset: 0x230050
// CHECK-NEXT:     Type: R_MORELLO_RELATIVE
// CHECK-NEXT:     Symbol: - (0)
// CHECK-NEXT:     Addend: 0x222008
// CHECK-NEXT:   }
...
// CHECK-NEXT: 0x00230030 00002200 00000000 04000000 00000004
