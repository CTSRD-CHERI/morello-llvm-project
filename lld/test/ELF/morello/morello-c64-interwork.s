...
// CHECK-LABEL: <_start>:
// CHECK-NEXT:   2101a8:       b       0x2101bc <__C64ADRPThunk_func2>

// CHECK-LABEL: <func>:
// CHECK-NEXT:   2101ac:       bl      0x2101bc <__C64ADRPThunk_func2>

// CHECK-LABEL: <func2>:
// CHECK-NEXT:   2101b0:       bl      0x2101c8 <__A64ToC64Thunk_func>
// CHECK-NEXT:                 b       0x2101d8 <__A64ToC64Thunk__start>
// CHECK-NEXT:                 ret

// CHECK-LABEL: <__C64ADRPThunk_func2>:
// CHECK-NEXT:   2101bc:       adrp    c16, 0x210000 <__C64ADRPThunk_func2>
// CHECK-NEXT:                 add     c16, c16, #432
// CHECK-NEXT:                 br      c16

// CHECK-LABEL: <__A64ToC64Thunk_func>:
// CHECK-NEXT:   2101c8:       bx      #4
// CHECK-EMPTY:
// CHECK-LABEL:   <$c>:
// CHECK-NEXT:   2101cc:       adrp    c16, 0x210000 <$c>
// CHECK-NEXT:                 add     c16, c16, #429
// CHECK-NEXT:                 br      c16

// CHECK-LABEL: <__A64ToC64Thunk__start>:
// CHECK-NEXT:   2101d8:       bx      #4
// CHECK-EMPTY:
// CHECK-LABEL:   <$c>:
// CHECK-NEXT:   2101dc:       adrp    c16, 0x210000 <$c>
// CHECK-NEXT:                 add     c16, c16, #425
// CHECK-NEXT:                 br      c16

// CHECK-SYM:        Name: __C64ADRPThunk_func2
// CHECK-SYM-NEXT:   Value: 0x2101BD
// CHECK-SYM-NEXT:   Size: 12
// CHECK-SYM-NEXT:   Binding: Local
// CHECK-SYM-NEXT:   Type: Function

// CHECK-SYM:        Name: $c
// CHECK-SYM-NEXT:   Value: 0x2101BC
// CHECK-SYM-NEXT:   Size: 0
// CHECK-SYM-NEXT:   Binding: Local
// CHECK-SYM-NEXT:   Type: None

// CHECK-SYM:        Name: __A64ToC64Thunk_func
// CHECK-SYM-NEXT:   Value: 0x2101C8
