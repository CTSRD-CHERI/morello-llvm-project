...
// NORELAX: .got 00000050 0000000000020430 DATA
// NORELAX-LABEL: <_start>:
// NORELAX-NEXT: 10360: adrp c0, 0x20000
/// Lower part of GOT address:
// NORELAX-NEXT: 10364: add  c0, c0, #0x430
// NORELAX-NEXT: 10368: ldp  x0, x1, [c0]
// NORELAX-NEXT: 1036c: adrp c0, 0x20000
/// Lower part of GOT address:
// NORELAX-NEXT: 10370: add  c0, c0, #0x440
// NORELAX-NEXT: 10374: ldp  x0, x1, [c0]

// CHECK: Relocations [
// CHECK-NEXT:   Section {{.*}} .rela.dyn {
// CHECK-NEXT:     0x20430 R_MORELLO_TLS_TPREL128 foo 0x0
// CHECK-NEXT:     0x20440 R_MORELLO_TLS_TPREL128 bar 0x0
