...
// RUN: llvm-mc --triple=aarch64-none-elf -filetype=obj invalid-globals-abi.s -o invalid-globals-abi.o
// RUN: not ld.lld invalid-globals-abi.o -o invalid-globals-abi 2>&1 | FileCheck %s --check-prefix=INVALID_GLOBALS_ABI
// RUN: llvm-mc --triple=aarch64-none-elf -filetype=obj invalid-tls-abi.s -o invalid-tls-abi.o
// RUN: not ld.lld invalid-tls-abi.o -o invalid-tls-abi 2>&1 | FileCheck %s --check-prefix=INVALID_TLS_ABI
// RUN: llvm-mc --triple=aarch64-none-elf -filetype=obj conflicting-globals-abi.s -o conflicting-globals-abi.o
