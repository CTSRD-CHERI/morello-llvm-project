...
// RUN: %clang_cheriseed -ffreestanding -E -dM -target x86_64-linux-gnu -mabi=purecap - < /dev/null | FileCheck -match-full-lines --check-prefix=CHECK-PURECAP %s
// RUN: %clang_cheriseed -ffreestanding -E -dM -target aarch64-linux-gnu - < /dev/null | FileCheck -match-full-lines %s
// RUN: %clang_cheriseed -ffreestanding -E -dM -target aarch64-linux-gnu -mabi=purecap - < /dev/null | FileCheck -match-full-lines --check-prefix=CHECK-PURECAP %s
...
// RUN: %clang_cheriseed -flegacy-pass-manager -ffreestanding -E -dM -target x86_64-linux-gnu -mabi=purecap - < /dev/null | FileCheck -match-full-lines --check-prefix=CHECK-PURECAP %s
...
// RUN: %clang_cheriseed -flegacy-pass-manager -ffreestanding -E -dM -target aarch64-linux-gnu -mabi=purecap - < /dev/null | FileCheck -match-full-lines --check-prefix=CHECK-PURECAP %s
