...
set(ALL_CHERISEED_SUPPORTED_ARCH ${X86_64} ${ARM64})
...
if(APPLE)
  ...
  list_intersect(LSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(CHERISEED_SUPPORTED_ARCH
    ALL_CHERISEED_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(CHERISEED_SUPPORTED_ARCH ${ALL_CHERISEED_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;cheriseed;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND CHERISEED_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_CHERISEED TRUE)
else()
  set(COMPILER_RT_HAS_CHERISEED FALSE)
endif()
