...
; CHECK: ldr    x4, [c3]                ; encoding: [0x64,0x00,0x40,0xf9]
; CHECK: ldr    x2, [csp, #32]           ; encoding: [0xe2,0x13,0x40,0xf9]
; CHECK: ldr    b5, [csp, #1]            ; encoding: [0xe5,0x07,0x40,0x3d]
; CHECK: ldr    h6, [csp, #2]            ; encoding: [0xe6,0x07,0x40,0x7d]
; CHECK: ldr    s7, [csp, #4]            ; encoding: [0xe7,0x07,0x40,0xbd]
; CHECK: ldr    d8, [csp, #8]            ; encoding: [0xe8,0x07,0x40,0xfd]
; CHECK: ldr    q9, [csp, #16]           ; encoding: [0xe9,0x07,0xc0,0x3d]
; CHECK: ldrb   w4, [c3]                ; encoding: [0x64,0x00,0x40,0x39]
; CHECK: ldrb   w5, [c4, #20]           ; encoding: [0x85,0x50,0x40,0x39]
; CHECK: ldrb	w2, [c3, _foo@PAGEOFF]  ; encoding: [0x62,0bAAAAAA00,0b01AAAAAA,0x39]
; CHECK: ldrb	w3, [c2, "+[Test method].var"@PAGEOFF] ; encoding: [0x43,0bAAAAAA00,0b01AAAAAA,0x39]
; CHECK: ldrsb  w9, [c3]                ; encoding: [0x69,0x00,0xc0,0x39]
; CHECK: ldrsb  x2, [csp, #128]          ; encoding: [0xe2,0x03,0x82,0x39]
; CHECK: ldrh   w2, [csp, #32]           ; encoding: [0xe2,0x43,0x40,0x79]
; CHECK: ldrsh  w3, [csp, #32]           ; encoding: [0xe3,0x43,0xc0,0x79]
; CHECK: ldrsh  x5, [c9, #24]           ; encoding: [0x25,0x31,0x80,0x79]
; CHECK: ldrsw  x9, [csp, #512]          ; encoding: [0xe9,0x03,0x82,0xb9]
...
; CHECK: str   x2, [csp, #32]            ; encoding: [0xe2,0x13,0x00,0xf9]
; CHECK: str   w5, [c4, #20]            ; encoding: [0x85,0x14,0x00,0xb9]
; CHECK: str   b5, [csp, #1]             ; encoding: [0xe5,0x07,0x00,0x3d]
; CHECK: str   h6, [csp, #2]             ; encoding: [0xe6,0x07,0x00,0x7d]
; CHECK: str   s7, [csp, #4]             ; encoding: [0xe7,0x07,0x00,0xbd]
; CHECK: str   d8, [csp, #8]             ; encoding: [0xe8,0x07,0x00,0xfd]
; CHECK: str   q9, [csp, #16]            ; encoding: [0xe9,0x07,0x80,0x3d]
; CHECK: strb  w4, [c3]                 ; encoding: [0x64,0x00,0x00,0x39]
; CHECK: strb  w5, [c4, #20]            ; encoding: [0x85,0x50,0x00,0x39]
; CHECK: strh  w2, [csp, #32]            ; encoding: [0xe2,0x43,0x00,0x79]
...
; CHECK-TODO: stlr   w3, [c6]                ; encoding: [0xc3,0xfc,0x9f,0x88]
; CHECK-TODO-NEXT: stlr   x3, [c6]                ; encoding: [0xc3,0xfc,0x9f,0xc8]
; CHECK-TODO-NEXT: stlrb  w3, [csp]                ; encoding: [0xe3,0xff,0x9f,0x08]
; CHECK-TODO-NEXT: stlrb  w3, [csp]                ; encoding: [0xe3,0xff,0x9f,0x08]
; CHECK-TODO-NEXT: stlrb  w3, [csp]                ; encoding: [0xe3,0xff,0x9f,0x08]
