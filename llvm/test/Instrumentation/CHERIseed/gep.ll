...
; CHECK-NEXT:  %3 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 32)
  %2 = getelementptr inbounds %struct.S, %struct.S addrspace(200)* %0, i64 1, i32 0
; CHECK-NEXT:  %4 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %3, i64 1, i32 2)
...
; CHECK-NEXT:  %6 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 16)
  %2 = getelementptr inbounds %struct.S addrspace(200)*, %struct.S addrspace(200)* addrspace(200)* %0, i64 1
; CHECK-NEXT:  %7 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap(%__cheriseed_cap_t* %6, %__cheriseed_cap_t* %3)
  %3 = load %struct.S addrspace(200)*, %struct.S addrspace(200)* addrspace(200)* %2, align 16
; CHECK-NEXT:  %8 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %4, %__cheriseed_cap_t* %7, i64 0)
  %4 = getelementptr inbounds %struct.S, %struct.S addrspace(200)* %3, i64 0, i32 0
; CHECK-NEXT:  %9 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %8, i64 1, i32 2)
; CHECK-NEXT:  %10 = inttoptr i64 %9 to i8*
; CHECK-NEXT:  store i8 2, i8* %10, align 16
  store i8 2, i8 addrspace(200)* %4, align 16
; CHECK-NEXT:  %11 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %5, %__cheriseed_cap_t* %7, i64 16)
  %5 = getelementptr inbounds %struct.S, %struct.S addrspace(200)* %3, i64 0, i32 1
; CHECK-NEXT:  tail call void @__cheriseed_store_cap(%__cheriseed_cap_t* %11, %__cheriseed_cap_t* %8)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %3 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %4 = tail call i64 @__cheriseed_address_get(%__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %8 = tail call %__cheriseed_cap_t* @__cheriseed_address_set(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %7)
...
; CHECK-NEXT:  %4 = sext i32 %1 to i64
  %3 = sext i32 %1 to i64
; CHECK-NEXT:  %5 = tail call i64 @__cheriseed_address_get(%__cheriseed_cap_t* %0)
; CHECK-NEXT:  %6 = inttoptr i64 %5 to i32*
; CHECK-NEXT:  %7 = getelementptr inbounds i32, i32* %6, i64 %4
; CHECK-NEXT:  %8 = ptrtoint i32* %7 to i64
; CHECK-NEXT:  %9 = tail call %__cheriseed_cap_t* @__cheriseed_address_set(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %8)
  %4 = getelementptr inbounds i32, i32 addrspace(200)* %0, i64 %3
; CHECK-NEXT:  %10 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %9, i64 4, i32 1)
...
; CHECK-NEXT:  %1 = tail call [2 x %struct.S2]* @C_S2()
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 16)
...
; CHECK-NEXT:  %2 = tail call i64 @__cheriseed_address_get(%__cheriseed_cap_t* %c)
...
; CHECK-NEXT:  %6 = tail call %__cheriseed_cap_t* @__cheriseed_address_set(%__cheriseed_cap_t* %1, %__cheriseed_cap_t* %c, i64 %5)
...
; CHECK-NEXT:  %6 = sext i32 %1 to i64
  %3 = sext i32 %0 to i64
; CHECK-NEXT:  %7 = tail call i64 @__cheriseed_address_get(%__cheriseed_cap_t* %2)
...
; CHECK-NEXT:  %11 = tail call %__cheriseed_cap_t* @__cheriseed_address_set(%__cheriseed_cap_t* %4, %__cheriseed_cap_t* %2, i64 %10)
  %4 = getelementptr inbounds %struct.S3, %struct.S3 addrspace(200)* %1, i64 0, i32 0, i64 %3
; CHECK-NEXT:  %12 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap(%__cheriseed_cap_t* %11, %__cheriseed_cap_t* %5)
  %5 = load i32 addrspace(200)*, i32 addrspace(200)* addrspace(200)* %4, align 16
; CHECK-NEXT:  %13 = tail call %__cheriseed_cap_t* @__cheriseed_copy_cap_with_offset(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %12, i64 0)
