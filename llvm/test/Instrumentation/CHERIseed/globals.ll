...
; CHECK-NEXT:  %3 = tail call %__cheriseed_cap_t* @cap_to_cap_200()
; CHECK-NEXT:  %4 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %1)
  %1 = load i32 addrspace(200)*, i32 addrspace(200)* addrspace(200)* @cap_to_cap_200, align 16
; CHECK-NEXT:  %5 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %4, i64 4, i32 1)
; CHECK-NEXT:  %6 = inttoptr i64 %5 to i32*
; CHECK-NEXT:  %7 = load i32, i32* %6, align 4
  %2 = load i32, i32 addrspace(200)* %1, align 4
; CHECK-NEXT:  %8 = tail call %__cheriseed_cap_t* @global_cap_200()
; CHECK-NEXT:  %9 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %8, i64 4, i32 1)
...
; CHECK-NEXT:  %12 = add nsw i32 %11, %7
  %4 = add nsw i32 %3, %2
; CHECK-NEXT:  %13 = tail call %__cheriseed_cap_t* @global_cap_200()
; CHECK-NEXT:  %14 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %13, i64 4, i32 2)
...
; CHECK-NEXT:  %16 = tail call %__cheriseed_cap_t* @ext_cap_to_cap_200()
; CHECK-NEXT:  %17 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap(%__cheriseed_cap_t* %16, %__cheriseed_cap_t* %2)
  %5 = load i32 addrspace(200)*, i32 addrspace(200)* addrspace(200)* @ext_cap_to_cap_200, align 16
; CHECK-NEXT:  %18 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %17, i64 4, i32 1)
...
; CHECK-NEXT:  %21 = add nsw i32 %20, %12
  %7 = add nsw i32 %6, %4
; CHECK-NEXT:  %22 = tail call %__cheriseed_cap_t* @global_cap_200()
; CHECK-NEXT:  %23 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %22, i64 4, i32 2)
...
; CHECK-NEXT:  %1 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = tail call %__cheriseed_cap_t* @ptr_to_cap()
; CHECK-NEXT:  %4 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %1)
  %1 = load i32 addrspace(200)*, i32 addrspace(200)** @ptr_to_cap, align 16
; CHECK-NEXT:  %5 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %4, i64 4, i32 1)
; CHECK-NEXT:  %6 = inttoptr i64 %5 to i32*
; CHECK-NEXT:  %7 = load i32, i32* %6, align 4
  %2 = load i32, i32 addrspace(200)* %1, align 4
; CHECK-NEXT:  %8 = tail call %__cheriseed_cap_t* @null_ptr_to_cap()
; CHECK-NEXT:  %9 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid(%__cheriseed_cap_t* %8, %__cheriseed_cap_t* %2)
  %3 = load i32 addrspace(200)*, i32 addrspace(200)** @null_ptr_to_cap, align 16
; CHECK-NEXT:  %10 = add nsw i32 %7, 42
  %4 = add nsw i32 %2, 42
; CHECK-NEXT:  %11 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %9, i64 4, i32 2)
