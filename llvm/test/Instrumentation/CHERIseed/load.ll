...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 2, i32 1)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 4, i32 1)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 16, i32 1)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 24, i32 1)
...
; CHECK-NEXT:  %3 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid(
...
; CHECK-NEXT:  %4 = tail call %__cheriseed_cap_t* @__cheriseed_load_cap(
