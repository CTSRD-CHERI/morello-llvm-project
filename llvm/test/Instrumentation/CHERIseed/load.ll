...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 2, i32 4, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 4, i32 4, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 16, i32 4, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 24, i32 4, i64 0)
...
; CHECK-SAME:     %__cheriseed_cap_t* %1, %__cheriseed_cap_t* %3, i64 0)
