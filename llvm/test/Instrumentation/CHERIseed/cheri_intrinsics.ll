...
; CHECK-NEXT:  %3 = call i64 @__cheriseed_length_get(%__cheriseed_cap_t* %0)
  %3 = call i64 @llvm.cheri.cap.length.get.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %4 = call i64 @__cheriseed_base_get(%__cheriseed_cap_t* %0)
  %4 = call i64 @llvm.cheri.cap.base.get.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %5 = call i64 @__cheriseed_copy_from_high(%__cheriseed_cap_t* %0)
  %5 = call i64 @llvm.cheri.cap.copy.from.high.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %6 = call i64 @__cheriseed_perms_get(%__cheriseed_cap_t* %0)
  %6 = call i64 @llvm.cheri.cap.perms.get.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %7 = call i64 @__cheriseed_flags_get(%__cheriseed_cap_t* %0)
  %7 = call i64 @llvm.cheri.cap.flags.get.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %8 = call i64 @__cheriseed_type_get(%__cheriseed_cap_t* %0)
  %8 = call i64 @llvm.cheri.cap.type.get.i64(i8 addrspace(200)* %0)
; CHECK-NEXT:  %9 = call i1 @__cheriseed_tag_get(%__cheriseed_cap_t* %0)
  %9 = call i1 @llvm.cheri.cap.tag.get(i8 addrspace(200)* %0)
; CHECK-NEXT:  %10 = call i1 @__cheriseed_sealed_get(%__cheriseed_cap_t* %0)
  %10 = call i1 @llvm.cheri.cap.sealed.get(i8 addrspace(200)* %0)
; CHECK-NEXT:  call void @__cheriseed_perms_check(%__cheriseed_cap_t* %0, i64 1)
  call void @llvm.cheri.cap.perms.check.i64(i8 addrspace(200)* %0, i64 1)
; CHECK-NEXT:  call void @__cheriseed_type_check(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
  call void @llvm.cheri.cap.type.check(i8 addrspace(200)* %0, i8 addrspace(200)* %0)
; CHECK-NEXT:  %11 = call i1 @__cheriseed_equal_exact(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
  %11 = call i1 @llvm.cheri.cap.equal.exact(i8 addrspace(200)* %0, i8 addrspace(200)* %0)
; CHECK-NEXT:  %12 = call i1 @__cheriseed_subset_test(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
  %12 = call i1 @llvm.cheri.cap.subset.test(i8 addrspace(200)* %0, i8 addrspace(200)* %0)
; CHECK-NEXT:  %13 = call i64 @__cheriseed_offset_get(%__cheriseed_cap_t* %0)
  %13 = call i64 @llvm.cheri.cap.offset.get(i8 addrspace(200)* %0)
; CHECK-NEXT:  %14 = call i64 @__cheriseed_diff(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
  %14 = call i64 @llvm.cheri.cap.diff(i8 addrspace(200)* %0, i8 addrspace(200)* %0)
; CHECK-NEXT:  %15 = call i64 @__cheriseed_address_get(%__cheriseed_cap_t* %0)
  %15 = call i64 @llvm.cheri.cap.address.get(i8 addrspace(200)* %0)
; CHECK-NEXT:  %16 = call i64 @__cheriseed_to_pointer(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
  %16 = call i64 @llvm.cheri.cap.to.pointer(i8 addrspace(200)* %0, i8 addrspace(200)* %0)
; CHECK-NEXT:  %17 = call i64 @__cheriseed_load_tags(%__cheriseed_cap_t* %0)
  %17 = call i64 @llvm.cheri.cap.load.tags.i64.p200i8(i8 addrspace(200)* %0)
; CHECK-NEXT:  %18 = call i64 @__cheriseed_round_representable_length(i64 1)
  %18 = call i64 @llvm.cheri.round.representable.length.i64(i64 1)
; CHECK-NEXT:  %19 = call i64 @__cheriseed_representable_alignment_mask(i64 1)
...
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_copy_to_high(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %3 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_perms_and(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %3 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_flags_set(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %3 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_bounds_set(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %3 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_bounds_set_exact(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %0, i64 %1)
...
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_tag_clear(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_seal(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_conditional_seal(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_unseal(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_seal_entry(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_stack_cap_get(%__cheriseed_cap_t* %2)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_offset_set(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_address_set(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 1)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_build(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_type_copy(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, %__cheriseed_cap_t* %0)
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_bounded_stack_cap(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %0, i64 1)
