...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 2, i32 2)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 4, i32 2)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 16, i32 2)
...
; CHECK-NEXT:  %1 = tail call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 24, i32 2)
...
; CHECK-NEXT:  tail call void @__cheriseed_store_cap_hybrid(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %1)
...
; CHECK-NEXT:  tail call void @__cheriseed_store_cap(%__cheriseed_cap_t* %0, %__cheriseed_cap_t* %1)
; CHECK-NEXT:  ret void
