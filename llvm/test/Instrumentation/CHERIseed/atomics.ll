...
; CHECK:  %v1 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %1, %__cheriseed_cap_t* %c, i8 0)
  %v1 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c monotonic, align 16
; CHECK:  %v2 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %c, i8 0)
  %v2 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c unordered, align 16
; CHECK:  %v3 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %c, i8 2)
  %v3 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c acquire, align 16
; CHECK:  %v4 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %4, %__cheriseed_cap_t* %c, i8 5)
