...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 1, i32 4, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 8, i32 4, i64 0)
; CHECK-NEXT:  %2 = inttoptr i64 %1 to i8**
...
; CHECK:  %v1 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %1, %__cheriseed_cap_t* %c, i8 0, i64 0)
  %v1 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c monotonic, align 16
; CHECK:  %v2 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %c, i8 0, i64 0)
  %v2 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c unordered, align 16
; CHECK:  %v3 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %c, i8 2, i64 0)
  %v3 = load atomic i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* %c acquire, align 16
; CHECK:  %v4 = call %__cheriseed_cap_t* @__cheriseed_load_cap_atomic(%__cheriseed_cap_t* %4, %__cheriseed_cap_t* %c, i8 5, i64 0)
...
; CHECK:  %v1 = call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid_atomic(%__cheriseed_cap_t* %1, %__cheriseed_cap_t* %c, i8 0)
  %v1 = load atomic i8 addrspace(200)*, i8 addrspace(200)** %c monotonic, align 16
; CHECK:  %v2 = call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid_atomic(%__cheriseed_cap_t* %2, %__cheriseed_cap_t* %c, i8 0)
  %v2 = load atomic i8 addrspace(200)*, i8 addrspace(200)** %c unordered, align 16
; CHECK:  %v3 = call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid_atomic(%__cheriseed_cap_t* %3, %__cheriseed_cap_t* %c, i8 2)
  %v3 = load atomic i8 addrspace(200)*, i8 addrspace(200)** %c acquire, align 16
; CHECK:  %v4 = call %__cheriseed_cap_t* @__cheriseed_load_cap_hybrid_atomic(%__cheriseed_cap_t* %4, %__cheriseed_cap_t* %c, i8 5)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 1, i32 8, i64 0)
; CHECK-NEXT:  %2 = inttoptr i64 %1 to i8*
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 8, i32 8, i64 0)
; CHECK-NEXT:  %2 = inttoptr i64 %1 to i8**
...
; CHECK:       call void @__cheriseed_store_cap_atomic(%__cheriseed_cap_t* %c, %__cheriseed_cap_t* null, i8 0, i64 0)
...
; CHECK:       call void @__cheriseed_store_cap_atomic(%__cheriseed_cap_t* %c, %__cheriseed_cap_t* null, i8 3, i64 0)
  store atomic i8 addrspace(200)* null, i8 addrspace(200)* addrspace(200)* %c release, align 16
; CHECK:       call void @__cheriseed_store_cap_atomic(%__cheriseed_cap_t* %c, %__cheriseed_cap_t* null, i8 5, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 1, i32 12, i64 0)
; CHECK-NEXT:  %2 = inttoptr i64 %1 to i8*
; CHECK-NEXT:  %3 = atomicrmw xchg i8* %2, i8 1 acquire
; CHECK-NEXT:  call void @__cheriseed_check_access_end(i64 %1, i64 1)
  %1 = atomicrmw xchg i8 addrspace(200)* %c, i8 1 acquire
; CHECK-NEXT:  %4 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 1, i32 12, i64 0)
...
; CHECK-NEXT:  %1 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 8, i32 12, i64 0)
; CHECK-NEXT:  %2 = inttoptr i64 %1 to i8**
; CHECK-NEXT:  %3 = atomicrmw xchg i8** %2, i8* %p acquire
; CHECK-NEXT:  call void @__cheriseed_check_access_end(i64 %1, i64 8)
  %1 = atomicrmw xchg i8* addrspace(200)* %c, i8* %p acquire
; CHECK-NEXT:  %4 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %c, i64 8, i32 12, i64 0)
; CHECK-NEXT:  %5 = inttoptr i64 %4 to i8**
...
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_rmw_cap(
; CHECK-SAME:     %__cheriseed_cap_t* %c, %__cheriseed_cap_t* %p, %__cheriseed_cap_t* %1, i8 0, i8 2, i64 0)
  %1 = atomicrmw xchg i8* addrspace(200)* addrspace(200)* %c, i8* addrspace(200)* %p acquire
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_rmw_cap(
; CHECK-SAME:     %__cheriseed_cap_t* %c, %__cheriseed_cap_t* %p, %__cheriseed_cap_t* %2, i8 1, i8 0, i64 0)
...
; CHECK-NEXT:  %1 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %2 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %3 = call %__cheriseed_cap_t* @__cheriseed_rmw_cap_hybrid(
...
; CHECK-NEXT:  %4 = call %__cheriseed_cap_t* @__cheriseed_rmw_cap_hybrid(
...
; CHECK-NEXT:  %"CHERIseed Alloca Insertion Point"
; CHECK-NEXT:  %1 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %v1 = call { %__cheriseed_cap_t*, i1 } @__cheriseed_cmpxchg_cap(
; CHECK-SAME:     %__cheriseed_cap_t* %c, %__cheriseed_cap_t* null, %__cheriseed_cap_t* %n,
; CHECK-SAME:     %__cheriseed_cap_t* %1, i8 0, i8 0, i64 0)
...
; CHECK-NEXT:  %1 = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %v1 = call { %__cheriseed_cap_t*, i1 } @__cheriseed_cmpxchg_cap_hybrid(
...
; CHECK-NEXT:  %3 = call i64 @__cheriseed_check_access(%__cheriseed_cap_t* %2, i64 8, i32 8, i64 0)
