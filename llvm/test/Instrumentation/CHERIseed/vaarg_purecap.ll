...
; CHECK-NEXT:  [[VA_SLOT_CAP:%.*]] = tail call %__cheriseed_cap_t*
...
; CHECK-NEXT:  tail call void @__cheriseed_store_cap_hybrid(%__cheriseed_cap_t*
...
; CHECK-NEXT:  [[VA_SLOT_SHADOW_CAP:%.*]] = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %u.cap =  tail call %__cheriseed_cap_t*
; CHECK-SAME:      @__cheriseed_stack_cap_init(%__cheriseed_cap_t*
...
; CHECK-NEXT:  [[U_ADDR:%.*]] = tail call i64 @__cheriseed_check_access(
...
; CHECK-NEXT:  [[VA_SLOT:%.*]] = alloca i8, i64 16, align 16
; CHECK-NEXT:  [[VA_SLOT_SHADOW_CAP:%.*]] = alloca %__cheriseed_cap_t, align 16
; CHECK-NEXT:  %s.cap =  tail call %__cheriseed_cap_t*
; CHECK-SAME:      @__cheriseed_stack_cap_init(%__cheriseed_cap_t*
