...
; RUN: opt -S -passes=instcombine -o - %s | llc -mtriple=aarch64 --relocation-model=pic -target-abi purecap -mattr=+morello,+c64 -O1 - -o - | %cheri_FileCheck %s --check-prefix ASM
