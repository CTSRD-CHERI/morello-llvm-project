...
@IF-MORELLO@; NOCODEPTR-NEXT:  .chericap  .L_Z8do_catchv$local+(.Ltmp2-.Lfunc_begin0)   {{#|//}}     jumps to .Ltmp2
@IFNOT-MORELLO@; CHECK-NEXT:  .chericap  .L_Z8do_catchv$local+(.Ltmp2-.Lfunc_begin0)   {{#|//}}     jumps to .Ltmp2
@IF-MORELLO@; CODEPTR-NEXT:  .chericap  .L_Z8do_catchv$local@code+(.Ltmp2-.Lfunc_begin0)   {{#|//}}     jumps to .Ltmp2
