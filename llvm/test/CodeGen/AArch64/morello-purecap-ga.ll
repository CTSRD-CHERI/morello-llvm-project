...
; CHECK-NEXT:    scbnds c2, c1, #4 // =4
; CHECK-NEXT:    add c3, c1, #4 // =4
; CHECK-NEXT:    add c1, c1, #804 // =804
; CHECK-NEXT:    scbnds c3, c3, #50, lsl #4 // =800
; CHECK-NEXT:    scbnds c1, c1, #50, lsl #4 // =800
...
; CHECK-NEXT:    add c1, c0, #804 // =804
; CHECK-NEXT:    add c0, c0, #4 // =4
; CHECK-NEXT:    scbnds c20, c1, #50, lsl #4 // =800
; CHECK-NEXT:    scbnds c21, c0, #50, lsl #4 // =800
; CHECK-NEXT:  .LBB1_2: // %for.body
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    lsl x8, x19, #2
; CHECK-NEXT:    ldr w9, [c21, x8]
; CHECK-NEXT:    add x19, x19, #1 // =1
; CHECK-NEXT:    add w10, w9, #1 // =1
; CHECK-NEXT:    str w10, [c21, x8]
...
; CHECK-NEXT:    adrp c0, .L__cap_merged_table
; CHECK-NEXT:    ldr c0, [c0, :lo12:.L__cap_merged_table]
; CHECK-NEXT:    add c1, c0, #4 // =4
; CHECK-NEXT:    add c2, c0, #804 // =804
; CHECK-NEXT:    scbnds c0, c1, #50, lsl #4 // =800
; CHECK-NEXT:    scbnds c1, c2, #50, lsl #4 // =800
; CHECK-NEXT:  .LBB2_2: // %for.body
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ldr w8, [c0], #4
; CHECK-NEXT:    cmp x0, x19
; CHECK-NEXT:    str w8, [c1], #4
...
; CHECK-NEXT:    mov w8, #3
; CHECK-NEXT:    add c1, c0, #4 // =4
; CHECK-NEXT:    add c0, c0, #804 // =804
; CHECK-NEXT:    scbnds c1, c1, #50, lsl #4 // =800
; CHECK-NEXT:    scbnds c0, c0, #50, lsl #4 // =800
...
; CHECK-NEXT:	.size	.L__cap_merged_table, 32
