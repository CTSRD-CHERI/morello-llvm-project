...
; CHECK-LABEL: @foo(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL68:%.*]] = call ptr addrspace(200) @bar()
...
; CHECK-NEXT:    [[UGLYGEP:%.*]] = getelementptr i8, ptr addrspace(200) [[CALL68]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[LSR_IV3:%.*]] = phi ptr addrspace(200) [ [[TMP9:%.*]], [[FOR_BODY932_US_US]] ], [ [[UGLYGEP]], [[FOR_COND930_PREHEADER_US_US]] ]
; CHECK-NEXT:    [[LSR_IV:%.*]] = phi i64 [ [[LSR_IV_NEXT:%.*]], [[FOR_BODY932_US_US]] ], [ [[TMP5]], [[FOR_COND930_PREHEADER_US_US]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = load double, ptr addrspace(200) [[LSR_IV3]], align 8
; CHECK-NEXT:    [[LSR_IV_NEXT]] = add i64 [[LSR_IV]], [[Z]]
; CHECK-NEXT:    [[UGLYGEP5:%.*]] = getelementptr i8, ptr addrspace(200) [[LSR_IV3]], i64 [[TMP3]]
...
;
entry:
  %call68 = call ptr addrspace(200) @bar()
  %0 = sext i32 %x to i64
...
for.body932.us.us:
  ...
  %arrayidx940.us.us = getelementptr inbounds double, ptr addrspace(200) %call68, i64 %2
  %3 = load double, ptr addrspace(200) %arrayidx940.us.us, align 8
