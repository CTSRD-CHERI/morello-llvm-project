...
define i64 @load_tags64(ptr %ptr) {
; CHECK: ldct x0, [x0]
  %ret = call i64 @llvm.cheri.cap.load.tags.i64.p0(ptr %ptr)
  ret i64 %ret
}

; CHECK-LABEL: load_tags32
define i32 @load_tags32(ptr %ptr) {
; CHECK: ldct x0, [x0]
  %ret = call i32 @llvm.cheri.cap.load.tags.i32.p0(ptr %ptr)
  ret i32 %ret
}

; CHECK-LABEL: load_tags128
define i128 @load_tags128(ptr %ptr) {
; CHECK: ldct x0, [x0]
; CHECK: mov x1, xzr
  %ret = call i128 @llvm.cheri.cap.load.tags.i128.p0(ptr %ptr)
  ret i128 %ret
}

; CHECK-LABEL: load_tags16
define i16 @load_tags16(ptr %ptr) {
; CHECK: ldct x0, [x0]
  %ret = call i16 @llvm.cheri.cap.load.tags.i16.p0(ptr %ptr)
  ret i16 %ret
}
...
declare i16 @llvm.cheri.cap.load.tags.i16.p0(ptr)
declare i128 @llvm.cheri.cap.load.tags.i128.p0(ptr)
declare i32 @llvm.cheri.cap.load.tags.i32.p0(ptr)
declare i64 @llvm.cheri.cap.load.tags.i64.p0(ptr)
