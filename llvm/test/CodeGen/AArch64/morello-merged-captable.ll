...
; MERGEOPT-NEXT:    ldr c1, [c1, :lo12:.L__cap_merged_table]
; MERGEOPT-NEXT:    add c3, c1, #4 // =4
; MERGEOPT-NEXT:    scbnds c2, c1, #4 // =4
; MERGEOPT-NEXT:    add c4, c1, #8 // =8
; MERGEOPT-NEXT:    add c5, c1, #12 // =12
; MERGEOPT-NEXT:    scbnds c3, c3, #4 // =4
; MERGEOPT-NEXT:    add c6, c1, #16 // =16
; MERGEOPT-NEXT:    add c7, c1, #20 // =20
; MERGEOPT-NEXT:    stp c2, c3, [c0, #0]
; MERGEOPT-NEXT:    scbnds c3, c4, #4 // =4
; MERGEOPT-NEXT:    scbnds c4, c5, #4 // =4
; MERGEOPT-NEXT:    add c8, c1, #24 // =24
; MERGEOPT-NEXT:    add c9, c1, #28 // =28
; MERGEOPT-NEXT:    stp c3, c4, [c0, #32]
; MERGEOPT-NEXT:    scbnds c4, c6, #4 // =4
; MERGEOPT-NEXT:    scbnds c5, c7, #4 // =4
; MERGEOPT-NEXT:    add c10, c1, #32 // =32
; MERGEOPT-NEXT:    add c11, c1, #36 // =36
; MERGEOPT-NEXT:    add c2, c1, #40 // =40
; MERGEOPT-NEXT:    add c3, c1, #44 // =44
; MERGEOPT-NEXT:    stp c4, c5, [c0, #64]
; MERGEOPT-NEXT:    scbnds c5, c8, #4 // =4
; MERGEOPT-NEXT:    scbnds c6, c9, #4 // =4
; MERGEOPT-NEXT:    add c4, c1, #48 // =48
; MERGEOPT-NEXT:    stp c5, c6, [c0, #96]
; MERGEOPT-NEXT:    add c5, c1, #52 // =52
; MERGEOPT-NEXT:    scbnds c6, c10, #4 // =4
; MERGEOPT-NEXT:    scbnds c7, c11, #4 // =4
; MERGEOPT-NEXT:    scbnds c2, c2, #4 // =4
; MERGEOPT-NEXT:    scbnds c3, c3, #4 // =4
; MERGEOPT-NEXT:    stp c6, c7, [c0, #128]
; MERGEOPT-NEXT:    add c6, c1, #56 // =56
; MERGEOPT-NEXT:    stp c2, c3, [c0, #160]
; MERGEOPT-NEXT:    add c2, c1, #60 // =60
; MERGEOPT-NEXT:    scbnds c3, c4, #4 // =4
; MERGEOPT-NEXT:    scbnds c4, c5, #4 // =4
; MERGEOPT-NEXT:    stp c3, c4, [c0, #192]
; MERGEOPT-NEXT:    scbnds c4, c6, #4 // =4
; MERGEOPT-NEXT:    scbnds c2, c2, #4 // =4
; MERGEOPT-NEXT:    add c3, c1, #64 // =64
; MERGEOPT-NEXT:    stp c4, c2, [c0, #224]
; MERGEOPT-NEXT:    add c2, c1, #68 // =68
; MERGEOPT-NEXT:    scbnds c3, c3, #4 // =4
; MERGEOPT-NEXT:    scbnds c2, c2, #4 // =4
; MERGEOPT-NEXT:    stp c3, c2, [c0, #256]
; MERGEOPT-NEXT:    add c2, c1, #72 // =72
; MERGEOPT-NEXT:    add c1, c1, #76 // =76
; MERGEOPT-NEXT:    scbnds c2, c2, #4 // =4
; MERGEOPT-NEXT:    scbnds c1, c1, #4 // =4
; MERGEOPT-NEXT:    stp c2, c1, [c0, #288]
...
; MERGEOPT-NEXT:	.size	.L__cap_merged_table, 48
