...
define { i8, i1 } @test_cmpxchg_8(ptr addrspace(200) %addr, i8 %desired, i8 %new) nounwind {
...
; CHECK-NEXT:    ret c30
  %res = cmpxchg ptr addrspace(200) %addr, i8 %desired, i8 %new seq_cst monotonic
  ret { i8, i1 } %res
}

define { i16, i1 } @test_cmpxchg_16(ptr addrspace(200) %addr, i16 %desired, i16 %new) nounwind {
...
; CHECK-NEXT:    cset w1, eq
; CHECK-NEXT:    ret c30
  %res = cmpxchg ptr addrspace(200) %addr, i16 %desired, i16 %new seq_cst monotonic
  ret { i16, i1 } %res
}

define { i32, i1 } @test_cmpxchg_32(ptr addrspace(200) %addr, i32 %desired, i32 %new) nounwind {
...
; CHECK-NEXT:    cset w1, eq
; CHECK-NEXT:    ret c30
  %res = cmpxchg ptr addrspace(200) %addr, i32 %desired, i32 %new seq_cst monotonic
  ret { i32, i1 } %res
}

define { i64, i1 } @test_cmpxchg_64(ptr addrspace(200) %addr, i64 %desired, i64 %new) nounwind {
...
; CHECK-NEXT:    cset w1, eq
; CHECK-NEXT:    ret c30
  %res = cmpxchg ptr addrspace(200) %addr, i64 %desired, i64 %new seq_cst monotonic
  ret { i64, i1 } %res
}

define { ptr addrspace(200), i1 } @test_cmpxchg_fatptr(ptr addrspace(200) %addr, ptr addrspace(200) %desired, ptr addrspace(200) %new) nounwind {
...
; CHECK-NEXT:    cset w1, eq
; CHECK-NEXT:    ret c30
  %res = cmpxchg ptr addrspace(200) %addr, ptr addrspace(200) %desired, ptr addrspace(200) %new seq_cst monotonic
  ret { ptr addrspace(200), i1 } %res
}
