...
;DEBUG: The chosen solution requires 3 instructions 6 regs, 0 fat regs, with addrec cost 1, plus 2 base adds, plus 5 setup cost
;DEBUG: The baseline solution requires 2 instructions 4 regs, 0 fat regs, with addrec cost 2, plus 3 setup cost
