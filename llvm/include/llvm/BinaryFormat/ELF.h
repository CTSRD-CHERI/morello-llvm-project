...
// CHERI ABI variant IDs.
enum : unsigned {
  CHERI_VARIANT_NONE = 0,

  // NT_CHERI_GLOBALS_ABI
  CHERI_VARIANT_GLOBALS_ABI_PCREL,    // CHERI_GLOBALS_ABI_PCREL
  CHERI_VARIANT_GLOBALS_ABI_PLT_FPTR, // CHERI_GLOBALS_ABI_PLT_FPTR
  CHERI_VARIANT_GLOBALS_ABI_FDESC,    // CHERI_GLOBALS_ABI_FDESC

  // NT_CHERI_TLS_ABI
  CHERI_VARIANT_TLS_ABI_TRAD, // CHERI_TLS_ABI_TRAD
};
