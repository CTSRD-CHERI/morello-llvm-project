...
inline constexpr ExtensionInfo Extensions[] = {
    ...
    {"morello", AArch64::AEK_MORELLO, "+morello", "-morello", FEAT_MAX, "", 0},
    {"c64", AArch64::AEK_C64, "+c64", "-c64", FEAT_MAX, "+morello", 0},
    // Special cases
...
static constexpr std::array<const ArchInfo *, 17> ArchInfos = {
    &ARMV8A,   &ARMV8_1A, &ARMV8_2A, &Morello, &ARMV8_3A, &ARMV8_4A, &ARMV8_5A,
