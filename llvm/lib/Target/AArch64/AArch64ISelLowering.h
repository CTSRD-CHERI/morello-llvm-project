...
enum NodeType : unsigned {
  ...
  CRET_GLUE, // Return with a glue operand. Operand 0 is the chain operand.
  RET_GLUEClear, // Return with a glue operand. Operand 0 is the chain operand.
                 // Clears unused registers.
  CRET_GLUEClear, // Capability return with a glue operand. Operand 0 is the
