...
public:
  enum VariantKind {
    ...
    VK_TGOT_G1           = VK_TGOT     | VK_G1,
    VK_TGOT_G0           = VK_TGOT     | VK_G0,
    VK_TGOT_G0_NC        = VK_TGOT     | VK_G0      | VK_NC,
    VK_TGOT_HI12         = VK_TGOT     | VK_HI12,
    VK_TGOT_LO12         = VK_TGOT     | VK_PAGEOFF,
    VK_TGOT_LO12_NC      = VK_TGOT     | VK_PAGEOFF | VK_NC,
    VK_GOTTGOT_PAGE      = VK_GOTTGOT  | VK_PAGE,
    VK_GOTTGOT_LO12_NC   = VK_GOTTGOT  | VK_PAGEOFF | VK_NC,
    VK_TLSDESC_LO12      = VK_TLSDESC  | VK_PAGEOFF,
    VK_TLSDESC_PAGE      = VK_TLSDESC  | VK_PAGE,
    VK_TGOT_TLSDESC_LO12 = VK_TGOT_TLSDESC | VK_PAGEOFF,
    VK_TGOT_TLSDESC_PAGE = VK_TGOT_TLSDESC | VK_PAGE,
