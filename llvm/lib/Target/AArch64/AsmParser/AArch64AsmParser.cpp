...
private:
  ...
  bool parseFeatures(StringRef ExtensionString, MCSubtargetInfo &STI,
                     AArch64::ArchInfo ArchInfo, SMLoc &L);
...
#include "AArch64GenAsmMatcher.inc"
  ...
  ParseStatus tryParseCSysReg(OperandVector &Operands);
  ParseStatus tryParseMorelloCSysReg(OperandVector &Operands);
  ParseStatus tryParseCapPerm(OperandVector &Operands);
  ParseStatus tryParseCapSealForm(OperandVector &Operands);
  ...
  ParseStatus tryParseC64CapToGPROperand(OperandVector &Operands);
...
static const struct Extension {
  ...
  const FeatureBitset CustomDisableFeatures = {};
  const FeatureBitset &getDisableFeatures() const {
    return CustomDisableFeatures.any() ? CustomDisableFeatures : Features;
  }
} ExtensionMap[] = {
    { "a64c", {AArch64::FeatureMorello}, {AArch64::FeatureMorello, AArch64::FeatureC64} },
    { "c64", {AArch64::FeatureMorello, AArch64::FeatureC64}, {AArch64::FeatureC64} },
...
bool AArch64AsmParser::parseDirectiveArch(SMLoc L) {
  ...
  bool Ret = parseFeatures(ExtensionString, STI, *ArchInfo, ArchLoc);
    ...
    for (const auto &Extension : ExtensionMap) {
      ...
      FeatureBitset ToggleFeatures =
          EnableFeature
              ...
              : STI.ToggleFeature(Features & Extension.getDisableFeatures());
